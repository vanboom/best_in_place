...
BestInPlaceEditor.prototype = {
    ...
    ajax: function (options) {
        ...
        options.url = this.url;
	       // inhibit this if datatype is script
    ...
    placeButtons: function (output, field) {
        'use strict';
        var buttondiv = $("<div class='bip-buttons'>");
        if (field.okButton) {
            buttondiv.append(
        ...
        if (field.okButton || field.cancelButton){
          output.append(buttondiv);
        }
